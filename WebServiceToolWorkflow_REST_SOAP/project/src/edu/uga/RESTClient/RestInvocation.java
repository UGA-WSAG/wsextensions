...
/**
 * This class takes in a REST url with the user inputs and invokes the web service
 * it returns the received response from the service as an xml or binary file
 * @author Singaram
 *
 */
public class RestInvocation
{
    ...
    /**
     * Invokes the REST service with given url and reads the stream sent from the web service
     * This method is called after setting the required parameters like the url and xml file name
     * @param method 
     * @return String 
     * @throws IOException 
     * @throws IOException 
